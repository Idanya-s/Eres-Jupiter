...
export default function App() {
  ...
  return (
    <div className="min-h-screen space-gradient text-slate-100 font-sans selection:bg-jupiter-ochre/35 selection:text-white flex flex-col justify-between overflow-x-hidden relative">
      ...
      <header className="relative border-b border-white/10 bg-[#050510]/60 backdrop-blur-md z-40">
        <div className="max-w-7xl mx-auto px-4 py-5 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-jupiter-dark to-jupiter-ochre flex items-center justify-center shadow-lg shadow-black/50">
              <span className="text-white font-space font-extrabold text-base">4🪐</span>
            </div>
            <div>
              <div className="flex items-center gap-2">
                <span className="text-[10px] font-mono text-jupiter-light uppercase tracking-widest font-semibold">SISTEMA GRAVITATORIO JÚPITER</span>
                <span className="w-1.5 h-1.5 rounded-full bg-red-500 animate-ping"></span>
              </div>
              <h1 className="text-xl font-space font-extrabold text-white tracking-wider title-gradient">ATRACCIÓN CÓSMICA</h1>
            </div>
          </div>

          {/* Birthday Target Personalizer (The girl he likes) */}
          <div className="flex items-center gap-3.5 bg-white/5 px-4 py-2.5 rounded-[24px] border border-white/10">
            <div className="text-right">
              <span className="text-[9px] font-mono text-purple-300/50 uppercase block tracking-wider leading-none">CUMPLEAÑOS DE HOY • 17 DE JULIO</span>
              <div className="text-jupiter-light text-sm font-space font-bold tracking-wide flex items-center gap-1.5 justify-end mt-0.5">
                <span>{targetName}</span>
              </div>
            </div>
            <div className="w-8 h-8 rounded-full bg-pink-500/15 border border-pink-500/30 flex items-center justify-center text-pink-400 animate-pulse">
      ...
      {/* MAIN BENTO LAYOUT */}
      <main className="max-w-7xl w-full mx-auto px-4 py-6 md:py-8 flex-grow space-y-6 relative z-10">
        
        {/* UPPER BANNER / LOVE GRAVITY ARGUMENT */}
        <section className="artistic-card p-6 md:p-8 relative overflow-hidden">
          <div className="absolute top-0 right-0 w-64 h-64 bg-jupiter-ochre/5 rounded-full blur-3xl pointer-events-none"></div>
          <div className="max-w-4xl">
            <div className="flex items-center gap-2 text-xs font-mono text-jupiter-ochre mb-2">
              <Sparkles className="w-3.5 h-3.5 text-jupiter-ochre" />
              <span>TEOREMA DE LA SINGULARIDAD GRAVITATORIA</span>
            </div>
            <h2 className="text-2xl md:text-3xl font-space font-extrabold text-white tracking-wide mb-3 title-gradient">
              ¿Por qué Júpiter?
            </h2>
            <p className="text-sm md:text-base text-[#e0d8d0] leading-relaxed font-serif italic">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
          ...
          <div className="lg:col-span-2 flex flex-col space-y-3">
            <div className="flex items-center justify-between px-2 text-xs font-mono text-purple-300/60">
              <span className="flex items-center gap-1.5">
                <Compass className="w-3.5 h-3.5 text-purple-400" />
                <span>MAPA ORBITAL EN TIEMPO REAL</span>
              </span>
              <span>COORD: RA 17h 17m / DEC -22° 42'</span>
            </div>
          ...
          <div className="flex flex-col space-y-6 h-full">
            ...
            <div className="artistic-card p-6 rounded-[24px] space-y-4">
              <h4 className="text-xs font-mono text-purple-400 uppercase tracking-widest border-b border-white/10 pb-2 flex items-center gap-2">
                <Activity className="w-4 h-4 text-jupiter-ochre" />
              ...
              <div className="space-y-1.5">
                ...
                />
                <p className="text-[10px] text-purple-400/50 font-mono text-right leading-none mt-1">
              ...
              <div className="bg-white/5 p-3.5 rounded-xl border border-white/10 space-y-3">
                <div className="flex justify-between items-center">
                  <span className="text-[11px] font-mono text-purple-300/70">MÚSICA MISTERIO CÓSMICO</span>
                  <span className={`text-[9px] font-mono px-1.5 py-0.5 rounded uppercase ${isPlayingMusic ? 'bg-jupiter-ochre/20 text-jupiter-light border border-jupiter-ochre/35' : 'bg-white/5 text-purple-400/50'}`}>
                ...
                {!isPlayingMusic && (
                  <p className="text-[10px] font-sans text-jupiter-light italic leading-snug">
        ...
        <section className="pt-4">
          ...
          <div className="artistic-card p-6 md:p-8 flex flex-col justify-between relative overflow-hidden">
            ...
            <div className="space-y-4 max-w-4xl mx-auto flex flex-col items-center">
              <div className="flex items-center gap-2 text-xs font-mono text-jupiter-light justify-center">
                <Star className="w-3.5 h-3.5 fill-jupiter-light text-jupiter-light" />
                <span>ALINEACIÓN CELESTIAL • 17 DE JULIO</span>
              </div>
              <h3 className="text-xl md:text-2xl font-space font-extrabold text-white tracking-wide title-gradient text-center">
                La Paradoja de la Atracción
              </h3>
              <p className="text-sm text-[#e0d8d0] leading-relaxed font-serif italic max-w-2xl text-center">
              ...
              <p className="text-sm text-[#e0d8d0] leading-relaxed font-serif italic max-w-3xl text-center font-normal">
              ...
              <div className="grid grid-cols-3 gap-6 pt-4 font-mono text-[10px] w-full max-w-lg">
                <div className="bg-white/5 p-3.5 rounded-lg border border-white/10 text-center">
                  <span className="text-purple-400 block mb-0.5 uppercase tracking-wider">Atracción</span>
                  <span className="text-jupiter-light font-bold font-space text-xs">INFINITA</span>
                </div>
                <div className="bg-white/5 p-3.5 rounded-lg border border-white/10 text-center">
                  <span className="text-purple-400 block mb-0.5 uppercase tracking-wider">Vel. Escape</span>
                  <span className="text-red-400 font-bold font-space text-xs">0.00 km/s</span>
                </div>
                <div className="bg-white/5 p-3.5 rounded-lg border border-white/10 text-center">
                  <span className="text-purple-400 block mb-0.5 uppercase tracking-wider">Destino</span>
                  <span className="text-pink-400 font-bold font-space text-xs">COINCIDIR</span>
                </div>
              </div>
            </div>

            <div className="border-t border-white/10 pt-6 mt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-2.5 text-xs text-purple-300/60 font-mono mx-auto sm:mx-0">
      ...
      {/* COMPACT FOOTER */}
      <footer className="border-t border-white/10 bg-[#050510]/80 py-6 text-center text-xs font-mono text-purple-400/50 relative z-10">
